      ...
      >
        <Menu.Items className="absolute -right-[90px] w-80 overflow-y-auto origin-top-right divide-y divide-gray-100 rounded-2xl bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
              ...
              <Menu.Item key={index}>
                {({ active }) => (
                  <Link
                    ...
                    to={category.route}
                  >
                    <div class="flex items-center justify-center flex-shrink-0 w-10 h-10 bg-[#eff9ff] text-[#00a8e7] rounded-md sm:h-12 sm:w-12 object-cover">
                      {category.thumbnail}
                    </div>
          ...
          <div class="p-4 bg-neutral-50">
            <a
              class="flow-root px-2 py-2 space-y-0.5 transition duration-150 ease-in-out rounded-md focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50"
              href="/shop"
            >
              <div class="flex items-center">
                <span class="text-sm font-medium ">Go to our shop</span>
              </div>
