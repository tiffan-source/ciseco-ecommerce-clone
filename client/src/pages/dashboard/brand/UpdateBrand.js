...
const UpdateBrand = () => {
  ...
  const [updateBrand, { isLoading: categoryBrand }] = useUpdateBrandMutation();
  const [updateBrandThumbnail, { isLoading: logoUploading }] =
        ...
        <>
          ...
          <section className="grid grid-cols-12 gap-8">
            ...
            <form
              ...
              onSubmit={handleSubmit(handleAddBrandForm)}
            >
