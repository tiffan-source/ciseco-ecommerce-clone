        ...
        <section className="container mx-auto px-4 lg:px-32 flex flex-col gap-y-32">
          ...
          <div className="flex flex-col gap-y-8">
            <h2 class="text-2xl font-semibold flex items-center">
              ...
              <span class="ml-1.5"> N/A · {review?.length} Reviews</span>
            </h2>
            <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-8">
              {review?.map((rev) => (
                <div
                  key={rev?._id}
                  class="flex flex-col shadow p-6 rounded-2xl h-fit mb-4"
                  data-nc-id="ReviewItem"
                >
                  <div class="flex space-x-4">
                    <div class="flex-shrink-0 pt-0.5">
                  ...
                  <div class="mt-4 prose prose-sm sm:prose sm:max-w-2xl">
                    <p class="text-slate-600">{rev?.description}</p>
                  </div>
                </div>
              ))}
              {/* review form */}
              <div
                class="flex flex-col shadow p-6 rounded-2xl h-fit"
                data-nc-id="ReviewItem"
              >
                <div class="flex space-x-4">
                  <div class="flex-shrink-0 pt-0.5">
